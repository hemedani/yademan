...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Yademan's mission to help you discover and remember meaningful places",
};
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-6">
                    ...
                    preserve your memories, and connect with others who share
                    your passion for exploration and storytelling.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-lg shadow-md text-center">
                  ...
                  <p className="text-gray-600">
                    Explore locations with our powerful map interface, featuring
                    detailed information and user-generated content.
                  </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-lg shadow-md text-center">
                  ...
                  <p className="text-gray-600">
                    Save and organize your favorite locations, create personal
                    collections, and never lose track of special places.
                  </p>
                </div>
                ...
                <div className="bg-white p-8 rounded-lg shadow-md text-center">
                  ...
                  <p className="text-gray-600">
                    Share your experiences and read stories from other travelers
                    to enrich your understanding of each location.
                  </p>
                </div>
              </div>
            </div>
