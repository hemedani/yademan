...
const mockLocations: Location[] = [
  {
    id: '1',
    title: 'تخت جمشید',
    description: 'تخت جمشید یکی از مهم‌ترین آثار باستانی ایران و از میراث جهانی یونسکو است که در دوره هخامنشی ساخته شده است.',
  ...
  },
  {
    ...
    description: 'میدان نقش جهان در اصفهان یکی از بزرگ‌ترین میادین جهان و از میراث جهانی یونسکو است.',
    category: 'میراث جهانی',
    rating: 4.9,
    reviewCount: 850,
    images: [
      '/images/naghsh-jahan-1.jpg',
      '/images/naghsh-jahan-2.jpg'
    ],
  ...
  },
  {
    id: '3',
    title: 'برج آزادی',
    description: 'برج آزادی نماد شهر تهران و یکی از مهم‌ترین بناهای یادبود ایران است.',
...
export async function getLocations(filters: LocationsFilters = {}): Promise<LocationsResponse> {
  // Simulate API delay
  ...
  if (filters.rating) {
    filteredLocations = filteredLocations.filter(location =>
      location.rating >= filters.rating!
    );
  }
...
export async function getRelatedLocations(locationId: string, limit: number = 3): Promise<Location[]> {
  // Simulate API delay
