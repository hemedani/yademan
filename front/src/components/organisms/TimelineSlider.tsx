...
const TimelineSlider: React.FC<TimelineSliderProps> = ({ className = "" }) => {
  ...
  const setPlaceFilters = useMapStore((state) => state.setPlaceFilters);
  ...
  return (
    <>
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-t from-[#121212] to-[#2a2a2a]/30 backdrop-blur-lg p-4 transition-all duration-300 ${
          isMinimized ? "h-16" : ""
        } ${className}`}
      >
        {!isMinimized ? (
          <div className="w-full relative">
            ...
            <div className="absolute top-2 left-0 right-0 z-40 flex justify-between px-4">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  aria-label={t("minimize", { defaultValue: "Minimize" })}
                >
                  <svg
          ...
          <div className="flex justify-between items-center px-4">
            ...
            <div className="text-center">
              <div className="text-xl font-bold bg-gradient-to-r from-[#FF007A] to-[#A020F0] bg-clip-text text-transparent">
                {Math.round(value)} {t("years")}
              </div>
            </div>
