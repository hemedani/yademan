    ...
    <>
      ...
      <AnimatePresence>
        ...
        >
          ...
          <motion.div
            className="relative max-h-[90vh] w-full max-w-3xl overflow-hidden rounded-2xl bg-[#0a0a00]/60 backdrop-blur-3xl shadow-2xl flex flex-col border border-[#333] shadow-[0_0_60px_rgba(255,0,122,0.2)]"
