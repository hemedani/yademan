...
const ProfileTabs: React.FC<ProfileTabsProps> = ({ defaultTab = 'overview' }) => {
  ...
  const tabs: Tab[] = [
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h3 className="text-lg font-semibold text-blue-900">مکان‌های بازدید شده</h3>
              <p className="text-2xl font-bold text-blue-600">۱۲</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg">
              <h3 className="text-lg font-semibold text-green-900">نظرات ثبت شده</h3>
              <p className="text-2xl font-bold text-green-600">۸</p>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg">
              <h3 className="text-lg font-semibold text-purple-900">علاقه‌مندی‌ها</h3>
    ...
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-4">مکان‌های مورد علاقه</h3>
          <div className="text-center py-8">
            <svg className="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
            </svg>
            <p className="text-gray-500">هنوز مکانی به علاقه‌مندی‌ها اضافه نکرده‌اید</p>
          </div>
        </div>
      )
    },
    {
      ...
      content: (
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-4">نظرات شما</h3>
          <div className="text-center py-8">
            <svg className="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">تنظیمات حساب کاربری</h3>
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600">مخفی کردن فعالیت‌های شما</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">اقدامات حساب</h3>
            <div className="space-y-3">
