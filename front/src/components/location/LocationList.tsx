  ...
  if (displayLocations.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-8 text-center">
        ...
        <p className="text-gray-500 text-lg">{t('noLocationsFound')}</p>
        <p className="text-gray-400 text-sm mt-2">{t('tryDifferentFilters')}</p>
      </div>
    );
  }
      ...
      {displayLocations.map((location) => (
        <div
          ...
          className={`bg-white rounded-lg shadow hover:shadow-md transition-shadow cursor-pointer border-2 ${
            selectedLocationId === location.id ? 'border-blue-500' : 'border-transparent'
          }`}
        >
          <div className="p-4">
            <div className="flex">
              ...
              <div className="flex-1 ml-4 min-w-0">
                ...
                {/* Address */}
                <p className="text-sm text-gray-600 truncate" title={location.address}>
                  {location.address}
                </p>
              </div>
            </div>
